...
eststo demographics: qui reg college_enrolled after1986 c.norm_ab_100000 c.ab_post_interact `controls' ///
	[pweight=edsuppwt], vce(cluster statefip)
estadd local State_yr_FE  "N"
estadd local Demographic_controls  "Y"
eststo dem_fe: qui reghdfe college_enrolled after1986 c.norm_ab_100000 c.ab_post_interact /// 
