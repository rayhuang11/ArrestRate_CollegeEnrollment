...
use "../UCR_ICPSR/clean//dta_final/ucr_avg_jb_alloffenses_1986.dta", clear
...
levelsof statefip if (norm_jb_100000 > `percentile_50' & year==1984)
...
sort statefip year
drop state
save "$outdir/cps_ucr_jb_18_merged_extended_1986.dta", replace

********************************************************************************
******************************** Merge 2010 ************************************
********************************************************************************

use "../UCR_ICPSR/clean//dta_final/ucr_avg_jb_alloffenses_2010.dta", clear
* PICK THE OFFENSE CODE TO KEEP HERE
drop if (offense != "18") 
...
sort statefip year
drop state
save "$outdir/cps_ucr_jb_18_merged_2010.dta", replace
