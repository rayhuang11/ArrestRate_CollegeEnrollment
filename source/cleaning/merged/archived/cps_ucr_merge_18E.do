*===============================================================================
* CPS & UCR Merge 18E (posession of opium, coke, derivatives) for AB
*===============================================================================
...
* Save dta file
save "$outdir/cps_ucr_18E_merged_1986.dta", replace
...
* Save dta file
save "$outdir/cps_ucr_18E_merged_2010.dta", replace
