...
\begin{figure}[h]
    ...
    \subfloat[\centering Race]{{\includegraphics[width=7cm]{pretrends/1986/college_enroll_byrace_1986.png} }}%
    \qquad
    \subfloat[\centering Sex]{{\includegraphics[width=7cm]{pretrends/1986/college_enroll_bysex_1986.png} }}%
  ...
  \begin{figure}[h]
    ...
    \subfloat[\centering Race]{{\includegraphics[width=7cm]{pretrends/1986/faminc_byrace_1986.png} }}%
    \qquad
    \subfloat[\centering Sex]{{\includegraphics[width=7cm]{pretrends/1986/faminc_bysex_1986.png} }}%
  ...
  \begin{figure}[h]
    ...
    \subfloat[\centering label 1]{{\includegraphics[width=7cm]{pretrends/2010/college_enroll_byrace_2010.png} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=7cm]{pretrends/2010/college_enroll_bysex_2010.png} }}%
  ...
  \begin{figure}[h]
    ...
    \subfloat[\centering Race]{{\includegraphics[width=7cm]{pretrends/2010/faminc_byrace_2010.png} }}%
    \qquad
    \subfloat[\centering Sex]{{\includegraphics[width=7cm]{pretrends/2010/faminc_bysex_2010.png} }}%
...
\clearpage
  ...
  \begin{figure}[h]
    ...
    \centering
    \includegraphics[width=1\textwidth]{eventstudy/high_drug_use/high_marijuana_eventstudy_1986_jb.png}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=1\textwidth]{eventstudy/high_drug_use/high_marijuana_eventstudy_2010_jb.png}
