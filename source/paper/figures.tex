...
\begin{figure}[h]
  ...
  \begin{figure}[h]
    ...
    \centering
    \includegraphics[width=1\textwidth]{heatmap/ab1986.png}
    \label{fig:heatmap}
  \end{figure}
  ...
  \begin{figure}[h]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{eventstudy/high_drug_use/high_drug_eventstudy_1986.png}
  ...
  \begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{eventstudy/high_drug_use/high_drug_eventstudy_nofe_1986.png}
...
\begin{figure}[h]
  ...
  \subfloat[\centering 1986]{{\includegraphics[width=7cm]{eventstudy/high_drug_use/reducedform_ab1986.png} }}%
  \qquad
  \subfloat[\centering 2010]{{\includegraphics[width=7cm]{eventstudy/high_drug_use/reducedform_ab2010.png} }}%
...
\begin{figure}[h]
  ...
  \subfloat[\centering 1986]{{\includegraphics[width=7cm]{eventstudy/high_drug_use/reducedform_jb1986.png} }}%
  \qquad
  \subfloat[\centering 2010]{{\includegraphics[width=7cm]{eventstudy/high_drug_use/reducedform_ab1986.png} }}%
