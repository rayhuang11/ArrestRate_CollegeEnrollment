...
replace college_enrolled_black = 1 if college_enrolled_edtype==1 & black==1
g college_enrolled_notblack = 0
replace college_enrolled_notblack = 1 if college_enrolled_edtype==1 & black==0
g two_yr_college = 0
...
loc summ_vars male black hs_grad college_enrolled_edtype /// 
