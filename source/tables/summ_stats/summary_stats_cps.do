...
loc summ_vars male black hs_grad college_enrolled college_enrolled_black /// 
	college_enrolled_notblack two_yr_college four_yr_college 
...
* Include 1986 and 2010 in one table
/*
esttab pre_period post_period using "$outdir/cps_1986_summ_stats.tex", ///
	...
	note("SD in ()." "Sample limited to ages 18-24. Observations missing education data were dropped. Weights included. Using CPS_UCR_18 dataset.")
eststo clear
*/
restore
...
loc summ_vars male black hs_grad college_enrolled /// 
	college_enrolled_black college_enrolled_notblack two_yr_college four_yr_college
loc presentation_table male black hs_grad college_enrolled ///
	four_yr_college
...
esttab pre_period1986 post_period1986 pre_period2010 post_period2010 using "$outdir/cps_summ_stats.tex", ///
	...
	mtitle("1984-86" "1987-92" "2000-09" "2010-16") ///
	label nostar /// 
	postfoot("\tabnotes{3}{SD in (). Sample limited to ages 18-24 inclusive. Observations with missing education data were dropped. CPS October supplement weights included. Using code 18.}")
	note("SD in ()." "Sample limited to ages 18-24. Obs missing educ data were dropped. Weights included. Using code 18.")
eststo clear
