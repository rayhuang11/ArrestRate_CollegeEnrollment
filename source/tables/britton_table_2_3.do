...
local controls age age2 // add to this
...
eststo simple: reg college_enrolled after1986 male sex_interaction [pweight=edsuppwt], vce(cluster statefip)
estadd local State_yr_FE  "N"
estadd local Demographic_controls  "N"
eststo demographics: reg college_enrolled after1986 male sex_interaction `controls' [pweight=edsuppwt], vce(cluster statefip)
estadd local State_yr_FE  "N"
estadd local Demographic_controls  "Y"
eststo dem_fe: areg college_enrolled after1986 male sex_interaction `controls' [pweight=edsuppwt], absorb(stratum) vce(cluster statefip)
estadd local State_yr_FE  "Y"
estadd local Demographic_controls  "Y"
* Create DiD table
